...
const UserProfile = () => {
  const { user: initialUser, logout, updateUserProfileImage } = useAuth()
  ...
  const handleAvatarUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      // Update local state
      setUser(prev => prev ? { ...prev, profileImage: result.secure_url } : null)
              ...
              <div className="profile-hero__avatar">
                ...
                {avatarUploading && (
                  <div className="profile-hero__upload-overlay">
                    ...
                    <span className="profile-hero__upload-percent">{avatarProgress}%</span>
                  </div>
                )}
              </div>
              <input
